...
| **优化/灵敏度分析** | ✅ Nelder-Mead + FD 中心差分灵敏度；蒙特卡洛良率分析 | ✅ 完整 | ❌ | ✅ | ✅ **核心** |
...
| **完整优化框架** | 梯度/遗传/统计优化 | rem-optim：Nelder-Mead + FD 梯度灵敏度 + Monte Carlo | 自动设计优化 |
| **良率/蒙特卡洛分析** | 完整统计仿真 | rem-optim MonteCarlo 模式；Gaussian 参数扰动 + 统计输出 | 制造良率预测 |
